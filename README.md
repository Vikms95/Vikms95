...
<ol>
   <li> doing the Intermediate HTML/CSS section, concepts like forms, CSS grid and preprocessors, to later apply them to my Todo-List project</li>
   <li> reading through 'YDKJS: Types and Grammar' book</li>ç
